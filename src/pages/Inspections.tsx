...
import { ClipboardCheck, Plus, User, Calendar, MapPin, FileDown } from "lucide-react";
...
import { exportInspectionsPDF } from "@/lib/pdf-export";

const Inspections = () => {
  const [inspections, setInspections] = useLocalStorage<Inspection[]>("k3-inspections", initialInspections);
    ...
    <div className="p-6 space-y-6 animate-fade-in">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          <Button variant="secondary" onClick={() => exportInspectionsPDF(inspections)}>
